...
void do_matmul_num(int test_num) {
  ...
  */ 
  ...
  // for (int i = 0; i < 64; i++){
  //   uint32_t results = cfu_op0(12, i, 0);
  //   printf ("a = %d: %lx >> %lx\n", i, A_arr[test_num][i], results);
  // }
  ...
  // for (int i = 0; i < 64; i++){
  //   uint32_t results = cfu_op0(13, i, 0);
  //   printf ("b = %d: %lx >> %lx\n", i, B_arr[test_num][i], results);
  // }
  ...
  for (int i = 0; i < 16; i++){
    for (int j = 0; j < 16; j+=4){
      // if (j%4 == 0)
        C_arr[i][j] = cfu_op0(9, K * (j/4) + i, 0);
      // else if (j%4 == 1)
        C_arr[i][j+1] = cfu_op0(8, K * (j/4) + i, 0);
      // else if (j%4 == 2)
        C_arr[i][j+2] = cfu_op0(7, K * (j/4) + i, 0);
      // else if (j%4 == 3)
        C_arr[i][j+3] = cfu_op0(3, K * (j/4) + i, 0);
    }
  }
  //  cfu_op0(0, (K << 8)+M , N);

  //   for(uint32_t i = 0; i < 64;i++){
  //     cfu_op0(1, A_arr[test_num][i], i);
  //     cfu_op0(2, B_arr[test_num][i], i);
  //   }

  //   // for(uint32_t i = 0; i < 64;i++){
  //   //   A_test = cfu_op0(8, 0, i);
  //   //   printf("A_arr[test_num][i]  = %08lX, A_test = %08lX\n", A_arr[test_num][i], A_test);
  //   // }
  //   // // printf("2\n");
  //   // for(uint32_t i = 0; i < 64;i++){
  //   //   B_test = cfu_op0(9, 0, i);
  //   //   printf("B_arr[test_num][i]  = %08lX, B_test = %08lX\n", B_arr[test_num][i], B_test);
  //   // }

  //   cfu_op0(7, 0,0);
  //   // printf("in_valid= %02ld\n", dum);
